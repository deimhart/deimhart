...
\begin{itemize}
        ...
        \item Dann \url{http://servername.tld/wiki} mit dem Browser ansteuern \pause
        \item An der Ubucon nutzen wir den Pfad \texttt{/srv/www/mediawiki.deimhart.net}
\end{itemize}
\end{block}
...
\begin{itemize}
        ...
        \item \texttt{create database datenbank-name;} \pause
