...
\begin{itemize}
	\item Übersicht \\
		\url{http://trac.edgewall.org/wiki/TracUsers} \pause
	\item Sourceforge \\
		\url{http://sourceforge.net/apps/trac/sourceforge/}
	\item ubuntuusers.de Webteam \\ 
		\url{http://trac.ubuntuusers.de/}
	\item Munin \\
		\url{http://munin-monitoring.org/}
	\item Gobby (sehr hübsch!) \\
		\url{http://gobby.0x539.de/trac/}
	\item Übersetzung des Subversion Buchs \\
		\url{http://www.svnbook.de/}
